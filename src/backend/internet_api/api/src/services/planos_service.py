            ...
            if plans:
                ...
                for plan in plans:
                    plan_data = {
                        ...
                        "velocidade_contratada": str(plan.velocidade_contratada),
                    }
    ...
    def create_plan(plan_data):
        try:            
            ...
            new_plan = PlanosModel(
                ...
                velocidade_contratada=plan_data["velocidade_contratada"]
            )
            new_plan.save()
        ...
        try:
            ...
            if plan:
                ...
                plan.update(
                    ...
                    velocidade_contratada=updated_plan_data.get("velocidade_contratada")
                )
