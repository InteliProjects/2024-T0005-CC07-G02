...
import DialogPlanoCarousel from "./dialogPlanoInternet";
...
interface CarouselInternetProps {
  planos: Plano[],
  carregandoPlanos: boolean
}

// Define o componente CarouselInternet, responsável por exibir um carrossel de planos de internet.
export default function CarouselInternet({ planos, carregandoPlanos }: CarouselInternetProps) {
  ...
  return (
    ...
    >
                ...
                <Card className="h-[450px]">
                  ...
                  <CardContent className="flex flex-col items-center justify-center gap-8 p-6">
                    ...
                    <div>
                      ...
                      <DialogPlanoCarousel plano={plano} />
                    </div>
                  </CardContent>
                </Card>
              </div>
      ...
      <CarouselPrevious />
      <CarouselNext />
      {/*Fim do componente que contém os itens do carrossel*/}
    </Carousel>
  )
}
