...
// Importa os componentes de card e dialog de ações de internet
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card";
import DialogAcoesInternet from "./dialogAcoesInternet";
// Importa o tipo (interface) Plano, para tipagem dos planos de internet
import { Plano } from "@/types/plano";
// Importa a biblioteca React para a criação de componentes
import React from 'react';

// Define as propriedades do componente CardPlanosInternet
interface CardPlanosInternetProps {
    planosContratados: Plano[];
		carregandoPlanosContratados: boolean;
}

// Componente funcional CardPlanosInternet que aceita as propriedades definidas acima 
export default function CardPlanosInternet({ planosContratados, carregandoPlanosContratados }: CardPlanosInternetProps)  {
                        ...
                        <Card className="flex flex-col justify-center w-1/2 md:w-full">
                            ...
                            <CardContent>
                                <div className="font-bold text-vivo flex justify-center items-center">
                                    <DialogAcoesInternet plano={plano} />
                                </div>
                            </CardContent>
                        </Card>
                    </React.Fragment>
