...
interface DialogPlanoCarouselTelefoniaProps {
  plano: Plano;
}

const contratarPlano = async (plano: Plano) => {
  const planoContratado = await post("/servicos_contratados_telefonia", {
    id_plano: plano.id,
...
export default function DialogPlanoCarousel({ plano }: DialogPlanoCarouselTelefoniaProps) {
  return (
    <AlertDialog>
      <AlertDialogTrigger>
